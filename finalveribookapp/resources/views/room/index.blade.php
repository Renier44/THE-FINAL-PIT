...
<body>
    <header>
        <div class="header-image">
            ...
            <img src="{{ asset('images/Pic1.jpg') }}" alt="Hotel Image">
    ...
    <section id="about">
        <div class="container">
            ...
            <div class="about-images">
                <img src="{{ asset('images/Pic6.jpg') }}" alt="Hotel View">
                <img src="{{ asset('images/Pic7.jpg') }}" alt="Hotel Interior">
                <img src="{{ asset('images/Pic8.jpg') }}" alt="Hotel Amenities">
                <img src="{{ asset('images/Pic9.jpg') }}" alt="Hotel Interior">
                <img src="{{ asset('images/Pic10.jpg') }}" alt="Hotel Amenities">
            </div>
        </div>
    </section>
    ...
    <section id="rooms">
        <div class="container">
            ...
            <div class="room-grid">
                <div class="room">
                    <img src="{{ asset('images/Pic2.jpg') }}" alt="Deluxe Room">
                ...
                <div class="room">
                    <img src="{{ asset('images/Pic3.jpg') }}" alt="Suite Room">
                    <div class="room-content">
                ...
                <div class="room">
                    <img src="{{ asset('images/Pic4.jpg') }}" alt="Family Room">
                    <div class="room-content">
                ...
                <div class="room">
                    <img src="{{ asset('images/Pic5.jpg') }}" alt="Executive Room">
                    <div class="room-content">
